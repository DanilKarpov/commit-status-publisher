...
<div id="runCustomBuildDiv">
  <div class="simpleTabs clearfix" style="margin-bottom: 0.5em;">
    <ul class="tabs">
      ...
      <c:set var="showChangesTab" value="${false}"/>
      <authz:authorize projectId="${runBuildBean.buildType.projectId}" allPermissions="CUSTOMIZE_BUILD_REVISIONS">
        <c:set var="showChangesTab" value="${runBuildBean.showChangesTab}"/>
        <c:if test="${showChangesTab}">
...
<div id="runCustomBuildHidden">
  ...
  <input type="hidden" name="personalPatchUploaded" value=""/>
</div>
...
<script type="text/javascript">
  ...
  BS.RunBuild.setTitleSuffix(' <bs:escapeForJs text="${runBuildBean.dialogTitleSuffix}" />');
</script>
