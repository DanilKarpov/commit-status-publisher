<h2>License Agreement for JetBrains<small>&reg;</small> TeamCity<small>&reg;</small></h2>
<div class="licenseAgreement">
<strong>IMPORTANT! READ CAREFULLY: THIS IS A LEGAL AGREEMENT. BY DOWNLOADING, INSTALLING, COPYING, SAVING ON YOUR COMPUTER, OR OTHERWISE USING THIS SOFTWARE, YOU (LICENSEE, AS DEFINED BELOW) ARE BECOMING A PARTY TO THIS AGREEMENT AND YOU ARE CONSENTING TO BE BOUND BY ALL THE TERMS AND CONDITIONS OF THIS AGREEMENT.</strong>
<br/><br/>
<strong>IF YOU DO NOT AGREE TO THE TERMS AND CONDITIONS OF THIS AGREEMENT, YOU SHOULD NOT DOWNLOAD, INSTALL AND USE THE SOFTWARE.</strong>
<br/><br/>
...
<br/>
(a) "Licensor" means JetBrains s.r.o. whose registered office is at Na hrebenech II 1718/10, Prague, 14000, Czech Republic, registered with Commercial Register kept by the Municipal Court of Prague, Section C, file 86211, ID.Nr.: 265 02 275.
<br/><br/>
...
<br/>
(a) "Build Agent" means an auxiliary part of Software that performs functions requested by Server as specified in the Software documentation.
<br/><br/>
(b) "Build Agent License" means a license to use an additional Build Agent subject to paragraph (iii) of clause 4(a) of this Agreement.
<br/><br/>
(c) "Enterprise Server License" means a license to use Software subject to paragraph (ii) of clause 4(a) of this Agreement.
<br/><br/>
(d) "License Certificate" means evidence of a license provided by Licensor to Licensee in electronic or printed form.
<br/><br/>
(e) "License Key" means a unique key-code that enables a Licensee to run the Software. Only Licensor and/or its representatives are permitted to produce License Keys for the Software.
<br/><br/>
(f) "Professional Server License" means a license to use Software subject to paragraph (i) of clause 4(a) of this Agreement.
<br/><br/>
(g) "Server" means a server part of Software that enables administration of User accounts and performs other services as specified in the Software documentation.
<br/><br/>
...
<br/><br/>
(i) "User" means (i) if Licensee is an individual, solely Licensee; (ii) if Licensee is a legal entity, any person who is authorized by Licensee to use Software while performing duties within the scope of his/her employment or assignment with Licensee, including its employee, independent contractor, temporary worker, and any third-party person, (iii) if Licensee meets the Open Source definition (<a href="https://www.opensource.org/docs/osd" target="_blank" rel="noreferrer">https://www.opensource.org/docs/osd</a>), an open source development group member who is authorized by Licensee to use Software for the purpose of open source development.
<br/><br/>
...
<strong>4. GRANT OF LICENSE</strong>
<br/>
...
<br/><br/>
(iii) in case of Enterprise Server License, use the same License key for running multiple Servers;
<br/><br/>
(iv) use a number of Build Agents exceeding the number of Build Agents granted under paragraphs (i), (ii) and (iii) of clause 4 (a), or use the same Build Agent License for running multiple Build Agents, or;
<br/><br/>
(v) in case of Professional Server License, use more build configurations on a single Server than granted under paragraph (i) of clause 4 (a)
<br/><br/>

<strong>(c) License Limitations for Open Source Development:</strong>
...
<br/><br/>
(ii) the purpose of use of Software shall be restricted solely to development of non-commercial open source projects that meet the Open Source Definition at <a href="https://www.opensource.org/docs/osd" target="_blank" rel="noreferrer">https://www.opensource.org/docs/osd</a>. Any commercial use of Software is expressly prohibited, and;
<br/><br/>
(iii) Licensee's right to use Software for open source development shall be limited to one (1) year. Licensee may renew its Enterprise Server License for another year free of charge by submitting a written request to Licensor thirty (30) days prior to the Enterprise Server License expiration.
<br/><br/>

<strong>5. THIRD PARTY SOFTWARE</strong>
<br/><br/>
(a) Licensee agrees to comply with the terms and conditions contained in Third-Party Software licenses with respect to the applicable Third-Party Software. Licensee may review all such Third Party Software licenses and/or notices in Software documentation under section "Third Party License Agreement".
<br/><br/>
...
<strong>6. RESTRICTED USE DURING EVALUATION PERIOD CONCERNING ENTERPRISE SERVER LICENSE</strong>
<br/><br/>
(a) In case of Enterprise Server License and subject to the terms of this Agreement, Licensee is granted the right to install and run Server for evaluation purposes without any charge for a period of sixty (60) days unless otherwise specified by Licensor ("Evaluation Period").
<br/><br/>
(b) Licensee's use of Server during Evaluation Period shall be limited to the internal evaluation for the sole purpose of determining whether Server meets Licensee's requirements and whether Licensee desires to continue using Server.
<br/><br/>
...
<br/><br/>
<strong>7.2 Licensor may terminate Upgrade Subscription if:</strong>
<br/><br/>
...
<br/><br/>
(D) Licensor elect to discontinue to provide Software, in whole or in part.
<br/><br/>
<strong>7.3 Licensor will make reasonable effort to notify Licensee via an email as follows:</strong>
<br/><br/>
(A) Thirty (30) days prior to termination of Upgrade Subscription in the events specified in Clauses 7.2 (C) and 7.2 (D), and in such events Licensee will be entitled to refund of unused portion of prepaid subscription fees, if applicable;
<br/><br/>
(B) Three (3) days prior to termination of Upgrade Subscription in the event specified in clause 7.2 (B).
<br/><br/>
<strong>7.4 If not agreed otherwise in writing between Licensor and Licensee, upon upgrading to new version of Software the relationship between parties shall be governed and amended (if applicable) by the terms and conditions of Licensee agreement related to Software available at www.jetbrains.com on the day of upgrade purchase.</strong>
<br/><br/>

<strong>8. PURCHASE AND PAYMENT</strong>
<br/><br/>
...
<strong>10. DISCLAIMER OF DAMAGES</strong>
<br/><br/>
...
<strong>11. EXPORT REGULATIONS</strong>
<br/><br/>
...
<br/>
Address: JetBrains s.r.o., Na hrebenech II 1718/10, Prague, 14000, Czech Republic
<br/>
Fax: +420 2 4172 2540<br/>
E-mail: <a href="mailto:sales@jetbrains.com">sales@jetbrains.com</a>
